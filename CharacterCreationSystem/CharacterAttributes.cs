...
namespace CharacterCreationSystem
{
    public class CharacterAttributes
    {
        ...
        public class CustomAttributes : IShowOptions
        {
            ...
            public void CustomizeAttributes()
            {
        ...
        public class CheckForErrors
        {
            ...
            {
                if (input.Length == 1 && char.ToLower(input[0]) >= 'a' && char.ToLower(input[0]) < 'a' + options.Length)
                {
                    return options[char.ToLower(input[0]) - 'a'];
                }
